...
const mensajesDeError = {
    ...
    password: {
        valueMissing: "Este campo de contraseña no puede estar vacío",
...
function mayorDeEdad(fecha) {
    const fechaActual = new Date(); //almacena en la variable la fecha actual
    const diferenciaDechas = new Date(
        fecha.getUTCFullYear() + 18,
        fecha.getUTCMonth(),
        fecha.getUTCDate()
    );

    return diferenciaDechas <= fechaActual;
};
